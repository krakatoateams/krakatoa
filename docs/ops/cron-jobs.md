...
- Job `recoverable` dengan TTL habis → purge folder `{userId}/resumable/{jobId}/`; refund hanya jika user sudah pernah Try again (`resumeAttempts >= 1`) tapi video tetap gagal dikirim
