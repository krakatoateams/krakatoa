...
export const TOOL_DEFAULTS: Record<string, ToolDefault> = {
  ...
  skills: { display_name: "Skills", enabled: true, visible_in_sidebar: true, coming_soon: false, sort_order: 7 },
  canvas: { display_name: "Canvas", enabled: true, visible_in_sidebar: true, coming_soon: false, sort_order: 8 },
  editor: { display_name: "Editor", enabled: true, visible_in_sidebar: true, coming_soon: false, sort_order: 9 },
