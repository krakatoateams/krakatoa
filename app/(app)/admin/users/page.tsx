      ...
      >
        <div className="flex flex-col">
          ...
          <input
            ...
            className="w-64 rounded-md border border-white/10 bg-white/[0.02] px-3 py-2 text-sm text-white outline-none focus:border-white/30"
          />
        </div>
        <div className="flex flex-col">
          ...
          <select
            ...
            className="rounded-md border border-white/10 bg-white/[0.02] px-3 py-2 text-sm text-white outline-none focus:border-white/30"
          >
                  ...
                  <td className="px-4 py-2 text-right">
                    {a.status === "active" ? (
                      <button
                        ...
                        disabled={busy}
                        onClick={() => revoke(a)}
                        className="rounded-md border border-white/10 px-3 py-1 text-xs text-gray-300 transition-colors hover:border-red-500 hover:text-red-400 disabled:opacity-50"
                      >
                        Revoke
                      </button>
                    ) : (
